...
public class TargetscaleTestTask extends AbstractTestTask {
	...
	protected void executeTask() throws Exception {
		...
		StandardCRUDTestTask crudtest = new StandardCRUDTestTask(
				numberOfEntries, AuthorizationBuilder.TARGETSCALE_MODULE_ID,
		...
		//
		// idTargetscaleList =
		// StringUtil.fromJsonArrayToStrings(responseTargetscale);
		...
		// throw new
		// Exception("Targetscale data are not successfully saved to the server!");
		// }
	}
