...
public class CardiodockTestTask extends AbstractTestTask {
	...
	protected void executeTask() throws Exception {
		...
		StandardCRUDTestTask crudtest = new StandardCRUDTestTask(
				numberOfEntries, AuthorizationBuilder.CARDIODOCK_MODULE_ID,
				Cardiodock.toJsonArray(cardiodockList));
		...
		// int preTestcountCardiodock = countData(oauthData.getDeviceToken(),
		// oauthData.getDeviceSecret(),
		// AuthorizationBuilder.CARDIODOCK_MODULE_ID,
		...
		//
		// // count the data
		// int countCardiodock = countData(oauthData.getDeviceToken(),
		// oauthData.getDeviceSecret(),
		// AuthorizationBuilder.CARDIODOCK_MODULE_ID,
		// oauthData.getAccessToken(),
		// oauthData.getAccessSecret());
		...
		// deleteJSONData(oauthData.getDeviceToken(),
		// oauthData.getDeviceSecret(),
		// AuthorizationBuilder.CARDIODOCK_MODULE_ID,
		// oauthData.getAccessToken(),
		...
		//
		// responseCardiodock = syncData(oauthData.getDeviceToken(),
		// oauthData.getDeviceSecret(),
		// AuthorizationBuilder.CARDIODOCK_MODULE_ID,
		// oauthData.getAccessToken(),
		// oauthData.getAccessSecret());
		// idCardiodockList =
		// StringUtil.fromJsonArrayToStrings(responseCardiodock);
		// if(idCardiodockList.size()!=preTestcountCardiodock){
		// throw new
		// Exception("Not all Cardiodock data deleted from the server");
		// }
	}
