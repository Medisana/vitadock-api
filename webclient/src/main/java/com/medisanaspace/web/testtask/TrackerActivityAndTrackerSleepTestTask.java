...
public class TrackerActivityAndTrackerSleepTestTask extends AbstractTestTask {
	...
	protected void executeTask() throws Exception {
		...
		int preTestcountTrackerActivity = countData(this.oauthData.getDeviceToken(),
		...
		int preTestcountTrackerSleep = countData(this.oauthData.getDeviceToken(),
				this.oauthData.getDeviceSecret(),
...
//		printer.logJSONData(data);
		...
		if(countTrackerActivity!=preTestcountTrackerActivity){
			...
			throw new Exception("Tracker activity data are not successfully deleted from the server!");
		}
		if(countTrackerSleep!= preTestcountTrackerSleep){
			...
			throw new Exception("Tracker sleep data are not successfully deleted from the server!");
		}
