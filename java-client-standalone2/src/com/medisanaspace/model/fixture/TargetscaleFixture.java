...
public class TargetscaleFixture {
	...
	private final Float expectedBodyFat = null;
	private final Float expectedBmi = null;
	private final Float expectedMuscleMass = null;
	private final Float expectedBoneMass = null;
	private final Float expectedBodyWater = null;
	private final Integer expectedKcal;
	private final Float expectedTargetWeight;
	private final Integer expectedAthletic;

	/**
	 * Constructor for TargetscaleFixture.
	 * @param index int
	 * @param maxEntries int
	 * @param lastTargetscale Targetscale
	 */
	public TargetscaleFixture(final int index, final int maxEntries, final Targetscale lastTargetscale) {
		this.targetscale = new Targetscale();

		this.expectedMeasurementDate = new Date(new Date().getTime()
				- (long) maxEntries * 3600L * 24L * 1000L + (long) index * 3600L * 24L * 1000L);
...
*/
	...
	/**
	 * Method getExpectedTargetWeight.
	 * @return Float
	 */
