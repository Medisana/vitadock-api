...
public class GlucodockglucoseFixture {
	...
	private Glucodockglucose glucodockGlucose = null;
	...
	private Integer expectedBloodGlucose;
	private Integer expectedBloodGlucoseTargetMin;
	private Integer expectedBloodGlucoseTargetMax;
	...
	public GlucodockglucoseFixture(final int index,
		...
		this.expectedBloodGlucose = RandomHelper.generateLong(
				Glucodockglucose.MIN_BLOOD_GLUCOSE,
				Glucodockglucose.MAX_BLOOD_GLUCOSE);

		if (lastGlucodockglucose == null) {
			this.expectedBloodGlucose = 95 + RandomHelper.generateInt(0, 10);
		} else {
			this.expectedBloodGlucose = lastGlucodockglucose.getBloodGlucose()
					+ RandomHelper.generateInt(0, 10) - 5;
			if (this.expectedBloodGlucose < 50) {
				this.expectedBloodGlucose = 50 - RandomHelper.generateInt(0, 2);
			} else if (this.expectedBloodGlucose > 140) {
